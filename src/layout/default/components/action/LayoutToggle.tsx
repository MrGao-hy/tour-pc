...
import { selectLayoutMode, setLayoutMode } from "@/store/reducer/settingSlice";
...
const LayoutToggle = () => {
  ...
  return (
    <Space>
      <LayoutShapeItem side={ { bgColor: "#333", z: 2 } }
                       top={ { bgColor: "#fff", z: 1 } }
                       isSelected={ layoutMode === "sidemenu" }
                       onSelected={ () => dispatch(setLayoutMode("sidemenu")) } />
      <LayoutShapeItem isSelected={ layoutMode === "topmenu" }
